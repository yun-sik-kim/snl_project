...
export default function WAMPage() {
  ...
  return (
    <div className="w-full h-full flex">
      ...
      <div className="ml-[80px] mt-16 w-full flex justify-center">
        <div className="flex flex-col p-6 space-y-8 max-w-6xl">
          {/* Top Card */}
          <div className="bg-green-100 border border-green-300 rounded-xl p-4 shadow-sm">
            ...
            <p className="text-sm text-gray-800">
              Add semesters and subjects, track your progress toward your WAM
              goal, and calculate total credits as you go.
            </p>
          </div>
